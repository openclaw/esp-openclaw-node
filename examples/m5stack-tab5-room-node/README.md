...
patching/copying BSP production source. The example pins esp_video 2.4.1 to
match the CSI compatibility patch's verified registry source; a newer version
requires qualifying that patch before changing the pin.
